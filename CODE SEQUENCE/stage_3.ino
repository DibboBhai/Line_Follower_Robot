...
int speed=90;  // INCRREASE OF SPEED _____________________________________________________________________>>>>
...
float kp = 45, kd =40, ki = 0;                   //-------- Values to be fine tuned ________________________TUNING OF VALUES
float per = 0;
float er = 0;
float I = 0;
float adj = 0;
