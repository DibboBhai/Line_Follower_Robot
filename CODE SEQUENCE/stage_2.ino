...
int speed=50;  // DECREASE OF SPEED _____________________________________________________________________>>>>
...
float kp =10, kd =5, ki = 0;                   //-------- Values to be fine tuned ________________________TUNING OF VALUES
float per = 0;
float er = 0;
float I = 0;
float adj = 0;
