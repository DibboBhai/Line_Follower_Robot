...
int speed=110;  // INCREASE OF SPEED _____________________________________________________________________>>>>
...
//------------SENSORS---------------------------------------------------
int left_most_sensor = A0;//left sensor pair ---- D1
int left_sensor = A1; //------------------------------- D2
int middle_sensor = A2;// extended sensor  ------- D3 
int right_sensor = A3;// right sensor pair  --D4
int right_most_sensor = A4; // --- D5
...
float kp = 22, kd =14, ki = 0;                   //-------- Values to be fine tuned ________________________TUNING OF VALUES
float per = 0;
float er = 0;
float I = 0;
float adj = 0;
...
void check(){                                                                         // ADDITION OF MORE CASES FOR BETTER PRECISION
...
else if((l== whit )&&(lm== blak )&&(m== blak )&&(rm== blak )&&(r== blak )) er = 4;

else if((l== blak )&&(lm== blak )&&(m== blak )&&(rm== blak )&&(r== whit )) er = -4;

else if((l== whit )&&(lm== whit )&&(m== blak )&&(rm== blak )&&(r== blak )) er = 4;

else if((l== blak )&&(lm== blak )&&(m== blak )&&(rm== whit )&&(r== whit )) er = -4;

else if((l== whit )&&(lm== whit )&&(m== whit )&&(rm== blak )&&(r== blak )) er = 5;

else if((l== blak )&&(lm== blak )&&(m== whit )&&(rm== whit )&&(r== whit )) er = -5;
